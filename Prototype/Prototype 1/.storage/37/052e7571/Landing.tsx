      ...
      <section className="relative py-20 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button size="lg" asChild className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg">
              <Link to="/login">
                Get Started <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
            <Button variant="outline" size="lg" asChild className="px-8 py-3 rounded-lg border-2">
              <Link to="/contact">
                Learn More
              </Link>
            </Button>
          ...
          {/* Problem Statement */}
          <Card className="max-w-4xl mx-auto mb-16 shadow-lg border-0 bg-white/90">
            <CardHeader>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <Card className="text-center border-0 shadow-lg bg-white">
              ...
              <CardContent>
                <p className="text-slate-600">
                  Real-time audio mapping generates phonetic output for multisensory learning
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" variant="secondary" asChild className="px-8 py-3 rounded-lg">
              <Link to="/login">
                Start Learning <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" asChild className="bg-transparent border-white text-white hover:bg-white hover:text-blue-600 px-8 py-3 rounded-lg">
              <Link to="/contact">
                Get in Touch
              </Link>
            </Button>
